...
SWIFT_CLASS("_TtC13CustomSegment12CAPSPageMenu")
...
@property (nonatomic, weak) id <CAPSPageMenuDelegate> _Nullable delegate;
...
@interface CAPSPageMenu (SWIFT_EXTENSION(CustomSegment)) <UIGestureRecognizerDelegate>
@end


@interface CAPSPageMenu (SWIFT_EXTENSION(CustomSegment))
@end

@class UIScrollView;

@interface CAPSPageMenu (SWIFT_EXTENSION(CustomSegment)) <UIScrollViewDelegate>
...
SWIFT_PROTOCOL("_TtP13CustomSegment20CAPSPageMenuDelegate_")
@protocol CAPSPageMenuDelegate
@optional
